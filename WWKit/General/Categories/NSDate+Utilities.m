...
- (BOOL) isSameWeekAsDate: (NSDate *) aDate
{
    ...
    return (abs((int)round([self timeIntervalSinceDate:aDate])) < D_WEEK);
}
...
#pragma mark 获取当前毫秒时间戳
-(NSString*)getCurHsecondTimeStamp
{
    long long totalMilliseconds=[self timeIntervalSince1970]*1000;
    NSString *createTs =[NSString stringWithFormat:@"%llu", totalMilliseconds];
    return createTs;
}
