...
@dynamic badge, badgeValue, badgeBGColor, badgeTextColor, badgeFont;
...
- (BarButtonJKActionBlock)actionBlock {
    return objc_getAssociatedObject(self, UIBarButtonItemJKActionBlock);
}

- (void)setActionBlock:(BarButtonJKActionBlock)actionBlock
{
